...
$apiKey = '7527123224:AAGziEn6Pt_zh-Db1121IIDhh-4Ztm1jdFY'; // Your Telegram bot API key
...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $caption = "
            ...
            🟢 Click 'Start Mining' to begin with 200 PPH for 3 hours.
            🟢  Upgrade your power and duration as you earn more RSC.
        ...
        // If there was a referrer, include their ID in the link
         $referralLink = $referrer_id ? "https://risingcoin.online/?ref={$referrer_id}" : "https://risingcoin.online";


        // Add referral link to caption if there was a referrer
        $caption .= "\n\n🎁 **Join through this link and double the fun:** ";
        ...
        if (file_exists($photoPath)) {
            ...
            $post_fields = [
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ['text' => 'Play Rising Coin Now', 'web_app' => ['url' => $referralLink]],
                            ['text' => 'Join Our Community', 'url' => 'https://t.me/risingcoin_rsc']]
                    ]
                ])
            ];
